...
struct FBaseBlendedCurve
{
	...
	*/
	...
	void Set(YSkeleton::AnimCurveUID InUid, float InValue)
	{
		int32 ArrayIndex;
	...
	float Get(YSkeleton::AnimCurveUID InUid) const
	{
		int32 ArrayIndex;
...
struct FRawCurveTracks
{
	 ...
	 */
	ENGINE_API void EvaluateTransformCurveData(YSkeleton * Skeleton, TMap<FName, FTransform>&OutCurves, float CurrentTime, float BlendWeight) const;
	...
	*/
	 ...
	 */
	ENGINE_API FAnimCurveBase * GetCurveData(YSkeleton::AnimCurveUID Uid, ESupportedCurveType SupportedCurveType = FloatType);
	/**
...
private:
	...
	DataType * GetCurveDataImpl(TArray<DataType>& Curves, YSkeleton::AnimCurveUID Uid);
