...
public:
	...
	*/
	 ...
	 */
	void FlipRotationWForNonRoot(YSkeletalMesh * SkelMesh);
	...
	*/
	 ...
	 */
	bool CreateAnimation(class YSkeletalMesh* Mesh);
	/**
...
private:
	...
	*/
	 ...
	 */
	//virtual void RemapTracksToNewSkeleton( YSkeleton* NewSkeleton, bool bConvertSpaces ) override;
	/**
	...
	void VerifyTrackMap(YSkeleton* MySkeleton=NULL);
