...
// Cached Virtual Bone data from YSkeleton
...
public:
	FReferenceSkeletonModifier(FReferenceSkeleton& InRefSkel, const YSkeleton* InSkeleton) : RefSkeleton(InRefSkel), Skeleton(InSkeleton) {}
...
public:
	 void RebuildRefSkeleton(const YSkeleton* Skeleton, bool bRebuildNameMap);
	...
	TArray<int32> RemoveBonesByName(YSkeleton* Skeleton, const TArray<FName>& BonesToRemove)
	{
