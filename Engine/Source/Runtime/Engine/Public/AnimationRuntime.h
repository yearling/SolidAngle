...
public:
	...
	**/
	...
	static void FillWithRetargetBaseRefPose(FCompactPose& OutPose, const YSkeletalMesh* Mesh);
#endif
	 ...
	 */
	static void EnsureParentsPresent(TArray<FBoneIndexType>& BoneIndices, YSkeletalMesh* SkelMesh);
	...
	static void FillUpComponentSpaceTransformsRefPose(const YSkeleton* Skeleton, TArray<FTransform> &ComponentSpaceTransforms);
	static void FillUpComponentSpaceTransformsRetargetBasePose(const YSkeleton* Skeleton, TArray<FTransform> &ComponentSpaceTransforms);
#endif
	...
	*/
 	//static void AppendActiveMorphTargets(const YSkeletalMesh* InSkeletalMesh, const TMap<FName, float>& InMorphCurveAnims, TArray<FActiveMorphTarget>& InOutActiveMorphTargets, TArray<float>& InOutMorphTargetWeights);
	...
	*/
	static void RetargetBoneTransform(const YSkeleton* MySkeleton, const FName& RetargetSource, FTransform& BoneTransform, const int32& SkeletonBoneIndex, const FCompactPoseBoneIndex& BoneIndex, const FBoneContainer& RequiredBones, const bool bIsBakedAdditive);
private:
	/** 
