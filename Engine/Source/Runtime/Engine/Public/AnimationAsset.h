...
public:
	...
	ENGINE_API void SetSkeleton(YSkeleton* NewSkeleton);
	void ResetSkeleton(YSkeleton* NewSkeleton);
	 ...
	 */
	ENGINE_API bool ReplaceSkeleton(YSkeleton* NewSkeleton, bool bConvertSpaces=false);
...
public:
	...
	ENGINE_API void SetPreviewMesh(YSkeletalMesh* PreviewMesh);
	ENGINE_API YSkeletalMesh* GetPreviewMesh();
	ENGINE_API YSkeletalMesh* GetPreviewMesh() const;
...
protected:
#if WITH_EDITOR
	virtual void RemapTracksToNewSkeleton(YSkeleton* NewSkeleton, bool bConvertSpaces);
#endif // WITH_EDITOR

public:
	class YSkeleton* GetSkeleton() const { return Skeleton; }
