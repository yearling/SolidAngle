...
struct FAnimSetMeshLinkup
{
	...
	TArray<int32> BoneToTrackTable;
		...
		void BuildLinkup(YSkeletalMesh* InSkelMesh, class UAnimSet* InAnimSet);
...
public:
	 ...
	 */
	virtual int32 GetMeshLinkupIndex(class YSkeletalMesh* SkelMesh);
...
public:
	 ...
	 */
	bool CanPlayOnSkeletalMesh(YSkeletalMesh* SkelMesh) const;

	/** Get Ratio of how much that mesh fits that animation set */
	float GetSkeletalMeshMatchRatio(YSkeletalMesh* SkelMesh) const;
