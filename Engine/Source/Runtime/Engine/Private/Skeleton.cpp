...
#if WITH_EDITOR
const FName YSkeleton::AnimNotifyTag = FName(TEXT("AnimNotifyList"));
const FString YSkeleton::AnimNotifyTagDelimiter = TEXT(";");

const FName YSkeleton::CurveTag = FName(TEXT("CurveUIDList"));
const FString YSkeleton::CurveTagDelimiter = TEXT(";");

const FName YSkeleton::RigTag = FName(TEXT("Rig"));
#endif 

// Names of smartname containers for skeleton properties
const FName YSkeleton::AnimCurveMappingName = FName(TEXT("AnimationCurves"));
const FName YSkeleton::AnimTrackCurveMappingName = FName(TEXT("AnimationTrackCurves"));
...
//
//void YSkeleton::PostInitProperties()
//{
...
//}
//
//void YSkeleton::PostDuplicate(bool bDuplicateForPIE)
//{
...
//void YSkeleton::ConvertToFReferenceSkeleton()
//{
...
//}
//
bool YSkeleton::DoesParentChainMatch(int32 StartBoneIndex, const YSkeletalMesh* InSkelMesh) const
{
...
bool YSkeleton::IsCompatibleMesh(const YSkeletalMesh* InSkelMesh) const
{
...
void YSkeleton::ClearCacheData()
{
	LinkupCache.Empty();
	SkelMesh2LinkupCache.Empty();
}

int32 YSkeleton::GetMeshLinkupIndex( YSkeletalMesh* InSkelMesh)
{
...
//
//void YSkeleton::RemoveLinkup(const USkeletalMesh* InSkelMesh)
//{
//	SkelMesh2LinkupCache.Remove(InSkelMesh);
//}
//
int32 YSkeleton::BuildLinkup( YSkeletalMesh* InSkelMesh)
{
	const FReferenceSkeleton& SkeletonRefSkel = ReferenceSkeleton;
	const FReferenceSkeleton& MeshRefSkel = InSkelMesh->RefSkeleton;
...
//
//void YSkeleton::RebuildLinkup(const USkeletalMesh* InSkelMesh)
//{
//	// remove the key
...
bool YSkeleton::MergeAllBonesToBoneTree(const YSkeletalMesh* InSkelMesh)
{
	if (InSkelMesh)
	{
...
bool YSkeleton::CreateReferenceSkeletonFromMesh(const YSkeletalMesh* InSkeletalMesh, const TArray<int32> & RequiredRefBones)
{
...
//
bool YSkeleton::MergeBonesToBoneTree(const YSkeletalMesh* InSkeletalMesh, const TArray<int32> & RequiredRefBones)
{
...
//
//void YSkeleton::SetBoneTranslationRetargetingMode(const int32& BoneIndex, EBoneTranslationRetargetingMode::Type NewRetargetingMode, bool bChildrenToo)
//{
...
//
//
//int32 YSkeleton::GetMeshBoneIndexFromSkeletonBoneIndex(const USkeletalMesh* InSkelMesh, const int32& SkeletonBoneIndex)
//{
...
//}
//
//void YSkeleton::AddNewAnimationNotify(FName NewAnimNotifyName)
//{
...
//}
//
//USkeletalMesh* YSkeleton::FindCompatibleMesh() const
//{
//	FARFilter Filter;
...
//}
//
//USkeletalMesh* YSkeleton::GetPreviewMesh(bool bFindIfNotSet)
//{
...
//}
//
//USkeletalMesh* YSkeleton::GetPreviewMesh() const
//{
//	return PreviewSkeletalMesh.Get();
//}
//
//USkeletalMesh* YSkeleton::GetAssetPreviewMesh(UAnimationAsset* AnimAsset)
//{
...
//}
//
//void YSkeleton::SetPreviewMesh(USkeletalMesh* PreviewMesh, bool bMarkAsDirty/*=true*/)
//{
//	if (bMarkAsDirty)
//	{
//		Modify();
...
//}
//
//void YSkeleton::LoadAdditionalPreviewSkeletalMeshes()
//{
//	AdditionalPreviewSkeletalMeshes.LoadSynchronous();
//}
//
//UPreviewMeshCollection* YSkeleton::GetAdditionalPreviewSkeletalMeshes() const
//{
//	return AdditionalPreviewSkeletalMeshes.Get();
//}
//
//void YSkeleton::SetAdditionalPreviewSkeletalMeshes(UPreviewMeshCollection* PreviewMeshCollection)
//{
//	Modify();
//
...
//}
//
//int32 YSkeleton::ValidatePreviewAttachedObjects()
//{
...
//#if WITH_EDITOR
//
//void YSkeleton::RemoveBonesFromSkeleton(const TArray<FName>& BonesToRemove, bool bRemoveChildBones)
//{
...
//}
//
//void YSkeleton::UnregisterOnSkeletonHierarchyChanged(void* Unregister)
//{
...
//
//const TArray<FAnimSlotGroup>& YSkeleton::GetSlotGroups() const
//{
//	return SlotGroups;
//}
//
//void YSkeleton::BuildSlotToGroupMap(bool bInRemoveDuplicates)
//{
...
//}
//
//bool YSkeleton::ContainsSlotName(const FName& InSlotName) const
//{
//	return SlotToGroupNameMap.Contains(InSlotName);
//}
//
//void YSkeleton::RegisterSlotNode(const FName& InSlotName)
//{
...
//}
//
//void YSkeleton::SetSlotGroupName(const FName& InSlotName, const FName& InGroupName)
//{
...
//}
//
//bool YSkeleton::AddSlotGroupName(const FName& InNewGroupName)
//{
...
//}
//
//FName YSkeleton::GetSlotGroupName(const FName& InSlotName) const
//{
//	const FName* FoundGroupNamePtr = SlotToGroupNameMap.Find(InSlotName);
...
//}
//
//void YSkeleton::RemoveSlotName(const FName& InSlotName)
//{
...
//}
//
//void YSkeleton::RemoveSlotGroup(const FName& InSlotGroupName)
//{
...
//}
//
//void YSkeleton::RenameSlotName(const FName& OldName, const FName& NewName)
//{
...
//
bool YSkeleton::GetSmartNameByName(const FName& ContainerName, const FName& InName, FSmartName& OutSmartName)
{
	const FSmartNameMapping* RequestedMapping = SmartNames.GetContainerInternal(ContainerName);
	if (RequestedMapping)
	{
...
//
SmartName::UID_Type YSkeleton::GetUIDByName(const FName& ContainerName, const FName& Name) const
{
	const FSmartNameMapping* RequestedMapping = SmartNames.GetContainerInternal(ContainerName);
	if (RequestedMapping)
	{
...
//}
//
//bool YSkeleton::AddNewVirtualBone(const FName SourceBoneName, const FName TargetBoneName, FName& NewVirtualBoneName)
//{
...
//}
//
//void YSkeleton::HandleVirtualBoneChanges()
//{
//	const bool bRebuildNameMap = false;
//	ReferenceSkeleton.RebuildRefSkeleton(this, bRebuildNameMap);
//
...
//
//#if WITH_EDITOR
//void YSkeleton::SetRigConfig(URig * Rig)
//{
...
//}
//
//int32 YSkeleton::FindRigBoneMapping(const FName& NodeName) const
//{
//	int32 Index = 0;
...
//}
//
//FName YSkeleton::GetRigBoneMapping(const FName& NodeName) const
//{
...
//}
//
//FName YSkeleton::GetRigNodeNameFromBoneName(const FName& BoneName) const
//{
//	for (const auto & NameMap : RigConfig.BoneMappingTable)
//	{
...
//}
//
//int32 YSkeleton::GetMappedValidNodes(TArray<FName> &OutValidNodeNames)
//{
...
//}
//
//bool YSkeleton::SetRigBoneMapping(const FName& NodeName, FName BoneName)
//{
...
//}
//
//void YSkeleton::RefreshRigConfig()
//{
...
//}
//
//URig * YSkeleton::GetRig() const
//{
//	return RigConfig.Rig;
//}
//
//void YSkeleton::GetAssetRegistryTags(TArray<FAssetRegistryTag>& OutTags) const
//{
...
//}
//
//UBlendProfile* YSkeleton::GetBlendProfile(const FName& InProfileName)
//{
...
//#endif //WITH_EDITOR
//
//USkeletalMeshSocket* YSkeleton::FindSocket(FName InSocketName) const
//{
//	int32 DummyIndex;
//	return FindSocketAndIndex(InSocketName, DummyIndex);
//}
//
//USkeletalMeshSocket* YSkeleton::FindSocketAndIndex(FName InSocketName, int32& OutIndex) const
//{
//	OutIndex = INDEX_NONE;
