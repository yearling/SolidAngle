...
void UAnimationAsset::ResetSkeleton(YSkeleton* NewSkeleton)
{
...
void UAnimationAsset::SetSkeleton(YSkeleton* NewSkeleton)
{
...
#if WITH_EDITOR
void UAnimationAsset::RemapTracksToNewSkeleton(YSkeleton* NewSkeleton, bool bConvertSpaces)
{
	SetSkeleton(NewSkeleton);
}

bool UAnimationAsset::ReplaceSkeleton(YSkeleton* NewSkeleton, bool bConvertSpaces/*=false*/)
{
	// if it's not same 
