...
bool UAnimSet::CanPlayOnSkeletalMesh(YSkeletalMesh* SkelMesh) const
{
...
float UAnimSet::GetSkeletalMeshMatchRatio(YSkeletalMesh* SkelMesh) const
{
...
int32 UAnimSet::GetMeshLinkupIndex(YSkeletalMesh* SkelMesh)
{
...
void FAnimSetMeshLinkup::BuildLinkup(YSkeletalMesh* InSkelMesh, UAnimSet* InAnimSet)
{
