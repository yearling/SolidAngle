...
void FSmartNameMapping::InitializeCurveMetaData(class YSkeleton* Skeleton)
{
...
/* initialize curve meta data for the container */
void FSmartNameContainer::InitializeCurveMetaData(class YSkeleton* Skeleton)
{
	FSmartNameMapping* CurveMappingTable = GetContainerInternal(YSkeleton::AnimCurveMappingName);
