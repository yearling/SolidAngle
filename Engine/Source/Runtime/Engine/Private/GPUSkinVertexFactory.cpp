	...
	*/
	virtual void SetMesh(FRHICommandList& RHICmdList, FShader* Shader, const FVertexFactory* VertexFactory, const FSceneView& View, const FMeshBatchElement& BatchElement, uint32 DataFlags) const override
	{
		...
		if(ShaderRHI)
		{
			...
			const auto FeatureLevel = ERHIFeatureLevel::SM5;
			...
			if (FeatureLevel >= ERHIFeatureLevel::ES3_1)
			{
				if(BoneMatrices.IsBound())
				{
					...
					FShaderResourceViewRHIParamRef CurrentData = ShaderData.GetBoneBufferForReading(false, 0).VertexBufferSRV;
				...
				if(PreviousBoneMatrices.IsBound())
				{
					...
					FShaderResourceViewRHIParamRef PreviousData = ShaderData.GetBoneBufferForReading(true, 0).VertexBufferSRV;
