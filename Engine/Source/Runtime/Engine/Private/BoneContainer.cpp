...
void FBoneContainer::RemapFromSkelMesh(YSkeletalMesh  & SourceSkeletalMesh, YSkeleton& TargetSkeleton)
{
...
void FBoneContainer::RemapFromSkeleton(YSkeleton const & SourceSkeleton)
{
