...
#define Engine_Source_Runtime_UMG_Public_Components_WidgetInteractionComponent_h_58_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->SetCustomHitResult(Z_Param_Out_HitResult); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FVector2D*)Z_Param__Result=this->Get2DHitLocation(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(FHitResult*)Z_Param__Result=this->GetLastHitResult(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->IsOverHitTestVisibleWidget(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->IsOverFocusableWidget(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->IsOverInteractableWidget(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UWidgetComponent**)Z_Param__Result=this->GetHoveredWidgetComponent(); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->ScrollWheel(Z_Param_ScrollDelta); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->SendKeyChar(Z_Param_Characters,Z_Param_bRepeat); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->PressAndReleaseKey(Z_Param_Key); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->ReleaseKey(Z_Param_Key); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->PressKey(Z_Param_Key,Z_Param_bRepeat); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->ReleasePointerKey(Z_Param_Key); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->PressPointerKey(Z_Param_Key); \
		P_NATIVE_END; \
	}
...
#define Engine_Source_Runtime_UMG_Public_Components_WidgetInteractionComponent_h_58_INCLASS_NO_PURE_DECLS \
	...
	friend UMG_API class UClass* Z_Construct_UClass_UWidgetInteractionComponent(); \
	public: \
	DECLARE_CLASS(UWidgetInteractionComponent, USceneComponent, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/UMG"), NO_API) \
