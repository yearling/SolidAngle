...
struct CORE_API FGenericPlatformMisc
{
	...
	*/
	...
	FORCEINLINE static uint32 GetKeyMap(uint32* KeyCodes, FString* KeFNames, uint32 MaxMappings)
	{
		return 0;
	}

	FORCEINLINE static uint32 GetCharKeyMap(uint32* KeyCodes, FString* KeFNames, uint32 MaxMappings)
	{
		return 0;
	}
...
protected:
	...
	*/
	static uint32 GetStandardPrintableKeyMap(uint32* KeyCodes, FString* KeFNames, uint32 MaxMappings, bool bMapUppercaseKeys, bool bMapLowercaseKeys);
