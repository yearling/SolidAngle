...
struct YGenericCrashContext;
struct YGenericMemoryWarningContext;
...
namespace EBuildConfigurations
{
	...
	*/
	CORE_API EBuildConfigurations::Type FromString(const YString& Configuration);
...
namespace EBuildTargets
{
	...
	*/
	CORE_API EBuildTargets::Type FromString(const YString& Target);
...
struct CORE_API YGenericPlatformMisc
{
	...
	*/
	static void SetCrashHandler(void(*CrashHandler)(const YGenericCrashContext& Context)) { }
	...
	*/
	DEPRECATED(4.14, "GetMacAddressString is deprecated. It is not reliable on all platforms")
		static YString GetMacAddressString();
	...
	*/
	DEPRECATED(4.14, "GetHasedMacAddressString is deprecated. It is not reliable on all platforms")
		static YString GetHashedMacAddressString();
	...
	*/
	DEPRECATED(4.14, "GetUniqueDeviceId is deprecated. Use GetDeviceId instead.")
		static YString GetUniqueDeviceId();
	...
	*/
	static void SetMemoryWarningHandler(void(*Handler)(const YGenericMemoryWarningContext& Context))
	{
	}
...
public:
	...
	*/
	static void NormalizePath(YString& InPath)
	{
	}
	...
	*/
	...
	static YString GetDefaultLocale();
	...
	*/
	static void SetOverrideGameDir(const YString& InOverrideDir);
	...
	*/
	static void GetValidTargetPlatforms(TArray<YString>& TargetPlatformNames);
	...
	*/
	static YString GetEpicAccountId();
	...
	*/
	static bool SetEpicAccountId(const YString& AccountId);
	...
	*/
	static const void PreLoadMap(YString&, YString&, void*)
	{}
	...
	*/
	static bool ShouldDisablePluginAtRuntime(const YString& PluginName)
	{
		return false;
	}
