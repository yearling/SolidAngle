...
struct CORE_API FMapErrors
{
    ...
    static YName MatchingLightGUID;
    ...
    static YName ActorLargeShadowCaster;
    ...
    static YName VolumeActorCollisionComponentNULL;
    ...
    static YName VolumeActorZeroRadius;
    ...
    static YName ShadowCasterUsingBoundsScale;
    
	static YName MultipleSkyLights;

	/** {ActorName} has WorldTrace blocked. It will be considered to be world geometry */
	static YName InvalidTrace;
    ...
    static YName BrushZeroPolygons;
    ...
    static YName CleanBSPMaterials;
    ...
    static YName LightComponentNull;
	...
	static YName StaticComponentHasInvalidLightmapSettings;

	/** Navigation */

	/** Paths need to be rebuilt: **TODO** */
	static YName RebuildPaths;
    ...
    static YName SkelMeshActorNoPhysAsset;
    ...
    static YName AudioComponentNull;
    ...
    static YName StaticMeshComponent;
    ...
    static YName LevelStreamingVolume;
    ...
    static YName NoLevelsAssociated;
...
public:
	...
	CORE_API static TSharedRef<FMapErrorToken> Create(const YName& InErrorName);

private:
	/** Private constructor */
	FMapErrorToken( const YName& InErrorName );
};
