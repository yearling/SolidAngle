...
* TFunctionRef<int32 (const YString& Name, float Scale)>
*
...
*     DoSomethingWithConvertingStringsToInts([](const YString& Str) {
*         return Str.Len();
*     });
*
...
*
* // A function taking a string and float and returning int32.  Parameter names are optional.
* TFunction<int32 (const YString& Name, float Scale)>
*
...
*
* // Something.h
* TFunction<YString (int32)> GetTransform();
*
* // Something.cpp
* TFunction<YString (int32)> GetTransform(const YString& Prefix)
* {
...
* void Func()
* {
*     TFunction<YString (int32)> Transform = GetTransform(TEXT("Hello"));
*
*     YString Result = Transform(5); // "Hello: 25"
* }
*/
template <typename FuncType>
