...
* Example:
*
* void Func(const int32 A, YString&& B)
* {
*     // Equivalent to:
*     // TTuple<int32, const TCHAR*, YString> MyTuple(A, TEXT("Hello"), MoveTemp(B));
...
* const TCHAR* Overloaded(const YString& Arg);
*
* void Func(const TTuple<int32, const TCHAR*, YString>& MyTuple)
* {
*     // Equivalent to:
