...
public:
	...
	* @see ImportTextItem
	*/
	CORE_API bool ExportTextItem(YString& ValueStr, FRandomStream const& DefaultValue, class UObject* Parent, int32 PortFlags, class UObject* ExportRootScope) const;
