...
struct YWindowsPlatformTypes : public YGenericPlatformTypes
{
#ifdef _WIN64
...
typedef YWindowsPlatformTypes YPlatformTypes;
...
#pragma warning(disable : 4100) // unreferenced formal parameter 未引用形参
