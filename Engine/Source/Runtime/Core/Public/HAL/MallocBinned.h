...
#		define BINNED_PEAK_STATCOUNTER(PeakCounter, CompareVal) ((PeakCounter) = YLinearColor::Max((PeakCounter), (CompareVal)))
#	else
...
#		define BINNED_PEAK_STATCOUNTER(PeakCounter, CompareVal)	{																												\
																	...
																	{																											\
																		...
																		NewPeak = YLinearColor::Max((PeakCounter), (CompareVal));														\
																	}																											\
