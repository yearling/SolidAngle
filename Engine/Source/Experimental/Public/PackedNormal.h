...
struct FPackedRGB10A2N
{
	...
	friend  FArchive& operator<<(FArchive& Ar, FPackedRGB10A2N& N);
	...
	static  FPackedRGB10A2N ZeroVector;
};
...
struct FPackedRGBA16N
{
	...
	friend  FArchive& operator<<(FArchive& Ar, FPackedRGBA16N& N);
	...
	static  FPackedRGBA16N ZeroVector;
};
